...
protracted_shift_fft* make_protracted_shift_fft(int n_fft, int nx, double dx, int *nd, 
			    int flags);
void qf_copy_x_protracted_shift(protracted_shift_fft *obj, double *x, int nd, int copy_in);
void qf_copy_ED_protracted_shift(protracted_shift_fft *obj, double *x, int idx);
void qf_setup_kern_protracted_shift(protracted_shift_fft *obj, double drift, double diffusion,
		   double dt, int nkl, int nkr);
void do_integrate_protracted_shift(protracted_shift_fft *obj, int star, int nt, int idx);
void propagate_t_protracted_shift(protracted_shift_fft *obj, int star, int idx);
void propagate_x_protracted_shift(protracted_shift_fft *obj, int idx);
