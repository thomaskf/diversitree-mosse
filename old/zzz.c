...
#void derivs_protractedrep_gslode(int, double, double*, const double *, double *);
#void derivs_protractedreptip_gslode(int, double, double*, const double *, double *);
...
static R_CallMethodDef R_CallDef[] = {
   ...
   CALLDEF(r_do_integrate_protracted_mutation, 11),
   CALLDEF(r_do_integrate_protracted_shift, 12),
   ...
   CALLDEF(r_make_protracted_mutation_fft, 4),
   CALLDEF(r_make_protracted_shift_fft, 4),
   CALLDEF(r_make_prosse_multi_fft, 4),
   CALLDEF(r_make_mosse_fft, 4),
...
static R_CMethodDef R_CDef[] = {
  ...
  GSLODEFUN(derivs_protractedrep_gslode),
  GSLODEFUN(derivs_protractedreptip_gslode),
  // continuous things
