...
// protracted-eqs-fftC
SEXP r_make_protracted_fft(SEXP r_nx, SEXP r_dx, SEXP r_nd, SEXP r_flags);
SEXP r_do_integrate_protracted(SEXP extPtr, SEXP vars, SEXP star, SEXP b, SEXP mu, SEXP lambda, 
		    SEXP drift, SEXP diffusion, SEXP nt, SEXP dt, 
		    SEXP padding);

// protracted-mutation-eqs-fftC
...
// protracted-shift-eqs-fftC
SEXP r_make_protracted_shift_fft(SEXP r_nx, SEXP r_dx, SEXP r_nd, SEXP r_flags);
SEXP r_do_integrate_protracted_shift(SEXP extPtr, SEXP vars, SEXP star, SEXP b, SEXP mu, SEXP lambda, 
		    SEXP s, SEXP drift, SEXP diffusion, SEXP nt, SEXP dt, 
		    SEXP padding);
		    
// prosse-multi-eqs-fftC
SEXP r_make_prosse-multi_fft(SEXP r_nx, SEXP r_dx, SEXP r_nd, SEXP r_flags);
SEXP r_do_integrate_prosse-multi(SEXP extPtr, SEXP vars, SEXP Et, SEXP star, SEXP b, SEXP mu, SEXP lambda, 
